...
![zsh auto complete](http://static.wulfric.me/R-zsh-autocomplete.png "zsh auto complete")

按下 tab 键显示出所有待选项后，再按一次 tab 键，即进入选择模式，进入选择模式后，按 tab 切向下一个选项，按 shift+tab 键切向上一个选项，ctrl+f/b/n/p 可以向前后左右切换。

![zsh tab 切换](http://static.wulfric.me/R-zsh-tab-tab.png "zsh tab 切换")
...
![proxychains](http://static.wulfric.me/proxychain.png "proxychains")
...
![htop](http://static.wulfric.me/htop.png "htop")
...
![ccat](http://static.wulfric.me/R-ccat.png "ccat")

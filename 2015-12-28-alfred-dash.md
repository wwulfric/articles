...
![空间翘曲](images/space-wrap.png "空间翘曲")
...
![Alfred Preference](images/alfred-preference.png)
...
![时间设置](images/systempreference-datetime-languageregion.png)
...
![alfred workflow 真相](images/R-alfred-zhenxiang.png)

![alfred workflow 示例](images/alfred-workflow-example.png)

豆瓣 workflow：输入 movie/music/book，查找豆瓣信息。
![alfred workflow douban](images/alfred-douban.png "alfred workflow douban")
...
![dash alfred](images/dash-alfred.png)

## 结语

直方图一样丛生的石头森林，命运之线下苦苦挣扎的傀儡，远方朝露晨雾中若隐若现的灯塔，这是个纷纷扰扰的世界。想要成为一个穿越时空的 ~~少女~~ 少年。[^1]

![穿越时空的少女](images/chuanyueshikongdeshaonv.png "穿越时空的少女")
